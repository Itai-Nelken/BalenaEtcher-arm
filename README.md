# WARNING: This repository is unmaintained. Please use [pi-apps](https://pi-apps.io/) to get the latest version or compile etcher yourself.
...
## Install
There are 2 ways to get this version of etcher:
