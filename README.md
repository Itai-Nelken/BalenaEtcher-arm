...
```
## compile
use my [compile script](compile-etcher_v1.5.110.sh). to run it, dow nload the [script](compile-etcher_v1.5.110.sh), open terminal in the directory where the script is, and type:
```sh-session
